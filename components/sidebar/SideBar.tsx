  ...
  return (
    <div className="flex flex-col justify-between    bg-purplishColor h-screen w-[260px] py-10 pl-4 ">
      ...
      <div className="flex flex-col gap-24">
        ...
        <div>
          <div>
            <SideBarLink title={"General"} keepOn={false}>
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
          ...
          <div>
            <SideBarLink title={"Billing"} keepOn={true}>
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
              ...
              >
                <g clip-path="url(#clip0_5_471)">
                  <path
                    ...
                    stroke={toogleColor ? "#1A194D" : "#62618F"}
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
      ...
      <div>
        <div className="flex items-center gap-1">
          ...
          {/* logout text */}
          <div>
            <p className="text-lightGray text-[14px]">Log out</p>
          </div>
        </div>
      </div>
    </div>
